/**
 * HTTP API Client for Task-Mind Web Service
 *
...
export async function waitForApi(): Promise<void> {
  ...
  try {
    ...
    throw new Error('Failed to connect to Task-Mind web service');
  }
}
...
// ============================================================
// Init API - Web-based task-mind initialization
// ============================================================
